...
const Signup = () => {
  ...
  return (
    <>
      <div className="bg-zinc-50 px-3 pt-4 pb-20">
        <form
          className="flex flex-col bg-white justify-between items-center py-10 px-3 sm:px-6 gap-y-6 w-full sm:w-3/5 mx-auto shadow-xl rounded-lg border-2 border-zinc-300"
          onSubmit={handleFormSubmit}
        >
          <img src="./logo.png" className="h-20 w-20" alt="logo" />
          <h3 className="text-3xl font-bold text-[#99C830] ">SIGN-UP</h3>
          {errorMessage && <p className="text-red-500">{errorMessage}</p>}
          <label
            htmlFor="name"
            className="flex flex-col w-full gap-y-2 cursor-pointer"
          >
            <span className="text-zinc-600 font-semibold">Full Name : </span>
            <input
              type="text"
          ...
          <label
            htmlFor="password"
            className="flex flex-col w-full gap-y-2 cursor-pointer relative"
          >
            <span className="text-zinc-600 font-semibold">Password : </span>
            <input
            ...
            />
            <span
              className="absolute grid place-items-center top-12 right-6 text-2xl text-zinc-500 cursor-pointer"
