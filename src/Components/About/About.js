    ...
    <div className="sm:w-11/12 m-auto">
      ...
      <div className="bg-gray-100 overflow-hidden  ">
          ...
          <div className="w-full md:w-1/2 sm:ml-2 flex flex-col justify-center">
            ...
            <div className="border shadow-md rounded-xl">
              <form className="flex flex-col p-3">
                ...
                <input className="mb-4 p-2 border border-gray-300 rounded-lg"
                  required
                  type="email" placeholder="Email..." />
                <label className="mb-2 font-semibold">Suggestion</label>
                <input className="mb-4 p-2 border rounded-lg
                   border-gray-300"
                  required
                  placeholder="Your suggestion..." />
                <button className="bg-green-700 text-white px-4 py-2 rounded-xl">Submit</button>
              </form>
            </div>
          </div>
        ...
        <div className="px-3 border-1 border-black rounded-lg pt-3 my-2 mx-3">
          <div id="4" className="lg:px-20 text-center flex flex-col items-center mx-4 overflow-hidden">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl font-bold text-gray-800 capitalize">
              LATEST DONATIONS
            </h3>

          </div>
          <div id="5" className="lg:px-20 flex flex-col md:flex-row justify-evenly gap-6 my-10 mx-4 overflow-hidden">
            ...
            <div className="flex flex-col items-center bg-green-50 mb-8 shadow-md rounded-lg p-6 ">
              ...
              <div className="flex flex-col items-center text-center justify-center">
                ...
                <p className="font-semibold">Donated <span className="text-blue-300 ">₹500</span> for food of Childrens</p>
                <Link className="text-blue-400 pt-2 flex items-center">Donate Now <span className="text-sm"><IoIosArrowForward /></span></Link>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center bg-green-50 mb-8 shadow-md rounded-lg p-6 ">
              ...
              <div className="flex flex-col items-center text-center justify-center">
                <p className="text-xl font-bold">Jonaki</p>
                <p className="font-semibold">Donated <span className="text-blue-300 ">₹500</span> for food of Childrens</p>
                <Link className="text-blue-400 flex items-center pt-2">Donate Now <span className="text-sm"><IoIosArrowForward /></span></Link>
              </div>
            </div>
